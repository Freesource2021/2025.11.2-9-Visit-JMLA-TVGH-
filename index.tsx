...
const initialItineraryData: ItineraryItem[] = [
  {
    ...
    time: '上午',
    title: '虎之門醫院 中央圖書室',
    originalTitle: '国家公務員共済組合連合会 中央図書室',
    description: {
      zh: '位於虎之門醫院內的國家公務員共済組合連合會中央圖書室，主要為醫療專業人員和研究人員提供服務。',
      ja: '虎の門病院内にある国家公務員共済組合連合会の中央図書室で、主に医療専門家や研究者にサービスを提供しています。',
    },
    isStarred: false,
    isPlaceholder: false,
    websiteUrl: 'https://toranomon.kkr.or.jp/section/support/library/',
  },
  {
    type: 'travel',
    id: 'travel-to-2',
    ...
    mapUrl: 'https://www.google.com/maps/dir/Toranomon+Hospital,+2+Chome-2-2+Toranomon,+Minato+City,+Tokyo,+Japan/St.+Luke\'s+International+University,+9-1+Akashicho,+Chuo+City,+Tokyo,+Japan',
    stops: [
        { zh: '虎ノ門ヒルズ', ja: '虎ノ門ヒルズ' },
        { zh: '銀座', ja: '銀座' },
        { zh: '築地', ja: '築地' },
