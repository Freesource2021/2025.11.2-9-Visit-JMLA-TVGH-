...
const initialItineraryData: ItineraryItem[] = [
  ...
  },
  {
    ...
    method: 'subway',
    description: {
      zh: '從東京慈惠會醫科大學前往神保町書店街',
      ja: '東京慈恵会医科大学から神保町古書店街へ',
    },
    mapUrl: 'https://www.google.com/maps/dir/The+Jikei+University+School+of+Medicine,+Nishishinbashi,+Minato+City,+Tokyo,+Japan/Jimbocho+Station,+Chiyoda+City,+Tokyo,+Japan/',
    stops: [
      { zh: '御成門', ja: '御成門' },
      { zh: '神保町', ja: '神保町' },
    ],
