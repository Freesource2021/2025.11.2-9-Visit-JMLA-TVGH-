...
const initialItineraryData: ItineraryItem[] = [
  ...
  {
    type: 'travel',
    id: 'travel-from-hotel-to-shinjuku-tour',
    duration: { zh: '約 30 分鐘', ja: '約 30 分' },
    method: 'subway',
    description: {
      zh: '從 Henn na Hotel 銀座前往新宿高速巴士總站，參加原宿導覽',
      ja: '変なホテル銀座から新宿高速バスターミナルへ、原宿ツアーに参加するため',
    },
    mapUrl: 'https://www.google.com/maps/dir/Henn+na+Hotel+Tokyo+Ginza,+Tsukiji,+Chuo+City,+Tokyo,+Japan/Tokyo+Tourist+Information+Center+at+Shinjuku+Expwy.+Bus+Terminal/',
    stops: [
        { zh: '築地', ja: '築地' },
        { zh: '銀座', ja: '銀座' },
        { zh: '新宿', ja: '新宿' },
  ...
  },
  {
    ...
    time: '上午',
    title: '明治神宮 & 原宿地區導覽',
    originalTitle: '明治神宮 & 原宿エリアツアー',
    description: {
      zh: '參加 Go Tokyo 提供的導覽服務 (路線 R8) 探索原宿及明治神宮。適逢「秋之大祭」期間 (11/1-11/3)，可欣賞傳統表演藝術。主要參觀點為隈研吾設計的明治神宮博物館。',
      ja: 'Go Tokyo 提供のガイドサービス（ルートR8）に参加し、原宿と明治神宮を散策します。期間中は「秋の大祭」(11/1-11/3)が開催され、伝統芸能が鑑賞できます。主な見学先は隈研吾氏設計の明治神宮ミュージアムです。',
    },
    isStarred: false,
    isPlaceholder: false,
    websiteUrl: 'https://www.gotokyo.org/tc/guide-services/exploring-harajuku/index.html',
    notes: '早上9:45前先到Tokyo Tourist Information Center at Shinjuku Expwy. Bus Terminal新宿旅遊中心集合。\n- 路線: R8 Exploring Streets and a Shrine of Harajuku\n- 費用: 1,050日圓 (3位成人，僅收現金)',
  },
  {
    type: 'travel',
    id: 'travel-12-to-14',
  ...
  },
  {
    ...
    time: '上午',
    title: '與JMLA代表會合',
    originalTitle: 'JMLA担当者と合流',
    description: {
      zh: '9:00 在飯店大廳與JMLA代表會合。',
      ja: '9:00 ホテルのロビーでJMLA担当者と合流します。',
    },
    isStarred: false,
    isPlaceholder: false,
    websiteUrl: '',
  ...
  },
  {
    ...
    day: { zh: '週二', ja: '火' },
    time: '上午',
    title: '國家公務員共濟組合聯合會 中央圖書室',
    originalTitle: '虎の門病院 中央図書室',
    description: {
      zh: '參觀位於虎之門醫院內的中央圖書室 (10:00-11:30)。該醫院隸屬於國家公務員共濟組合聯合會，其圖書室是專為醫療專業人員服務的專業圖書館。',
      ja: '虎の門病院内にある中央図書室を見学します (10:00-11:30)。この病院は国家公務員共済組合連合会に所属しており、その図書室は医療専門家向けの専門図書館です。',
    },
    isStarred: false,
    isPlaceholder: false,
  ...
  },
  {
    ...
    mapUrl: 'https://www.google.com/maps/dir/Toranomon+Hospital,+Toranomon,+Minato+City,+Tokyo,+Japan/Tsukiji+Outer+Market,+4+Chome-16-2+Tsukiji,+Chuo+City,+Tokyo+104-0045,+Japan/',
    stops: [
        { zh: '神谷町', ja: '神谷町' },
        { zh: '築地', ja: '築地' },
    ],
  ...
  },
  {
    ...
    time: '下午',
    title: '築地場外市場午餐 (自由覓食)',
    originalTitle: '築地場外で分散して昼食',
    description: {
      zh: '於築地場外市場享用午餐。此處匯集了眾多海鮮丼、壽司、玉子燒等著名小吃店家，可自由選擇。',
      ja: '築地場外市場で昼食。海鮮丼、寿司、玉子焼きなど、有名な軽食店が数多く集まっており、自由に選べます。',
    },
    isStarred: false,
    isPlaceholder: false,
  ...
  },
  {
    ...
    method: 'walk',
    description: {
      zh: '從築地場外市場步行至聖路加國際大學',
      ja: '築地場外市場から聖路加国際大学まで徒歩',
    },
    mapUrl: 'https://www.google.com/maps/dir/Tsukiji+Outer+Market,+4+Chome-16-2+Tsukiji,+Chuo+City,+Tokyo+104-0045,+Japan/St.+Luke\'s+International+University,+Akashicho,+Chuo+City,+Tokyo,+Japan/',
    notes: '',
  },
  {
    type: 'event',
    ...
    day: { zh: '週二', ja: '火' },
    time: '下午',
    title: '聖路加國際大學圖書館 & 健康導航點 るかなび',
    originalTitle: '聖路加国際大学 図書館 & Health navigation spot: Lukenavi',
    description: {
      zh: '參訪聖路加國際大學 (14:00-16:00)，位於東京都中央區，是以護理和醫學教育聞名的私立大學，也是日本最具代表性的護理學校之一。',
      ja: '聖路加国際大学を訪問します (14:00-16:00)。東京都中央区に位置し、看護学と医学教育で知られる私立大学であり、日本を代表する看護学校の一つです。',
    },
    isStarred: true,
    isPlaceholder: false,
  ...
  {
    type: 'travel',
    id: 'travel-2-to-hotel',
    duration: { zh: '約 15 分鐘', ja: '約 15 分' },
    method: 'walk',
    description: {
      zh: '步行返回飯店。',
      ja: 'ホテルまで徒歩で戻ります。',
    },
    mapUrl: 'https://www.google.com/maps/dir/St.+Luke\'s+International+University,+Akashicho,+Chuo+City,+Tokyo,+Japan/Henn+na+Hotel+Tokyo+Ginza,+2+Chome-2-1+Tsukiji,+Chuo+City,+Tokyo+104-0045,+Japan/',
    notes: '',
  },
  {
    type: 'travel',
    id: 'travel-hotel-to-asakusa',
    duration: { zh: '約 25 分鐘', ja: '約 25 分' },
    method: 'subway',
    description: {
      zh: '從飯店前往淺草寺參加晚間導覽',
      ja: 'ホテルから浅草寺へ夜のツアーに参加します',
    },
    mapUrl: 'https://www.google.com/maps/dir/Henn+na+Hotel+Tokyo+Ginza,+2+Chome-2-1+Tsukiji,+Chuo+City,+Tokyo+104-0045,+Japan/Senso-ji+Temple,+2+Chome-3-1+Asakusa,+Taito+City,+Tokyo+111-0032,+Japan/',
    stops: [
      { zh: '築地', ja: '築地' },
      { zh: '東銀座', ja: '東銀座' },
      { zh: '淺草', ja: '浅草' },
  ...
  },
  {
    ...
    time: '晚上',
    title: '淺草寺免費導覽',
    originalTitle: '浅草寺無料ツアー',
    description: {
      zh: '參加由 Go Tokyo 提供的免費導覽服務，探索夜晚的淺草寺。導覽時間為 18:00 開始, 17:45分在淺草文化觀光中心1F集合。',
      ja: 'Go Tokyo が提供する無料ガイドサービスに参加し、夜の浅草寺を散策します。ツアーは18:00開始です, 17:45に浅草文化観光センター1階で集合します。',
    },
    isStarred: false,
    isPlaceholder: false,
    websiteUrl: 'https://www.gotokyo.org/tc/guide-services/index.html',
    notes: '此為東京都廳提供的免費導覽服務，需事先預約。\nR16 Asakusa Night Tour Meeting place: 淺草文化觀光中心 1樓 Asakusa Culture Tourist Information Center 1st floor information lobby (日本〒111-0034 Tokyo, Taito City, Kaminarimon, 2 Chome−18−9)',
  },
  {
    type: 'travel',
    id: 'travel-asakusa-to-hotel',
    duration: { zh: '約 25 分鐘', ja: '約 25 分' },
    method: 'subway',
    description: {
      zh: '從淺草返回飯店',
    ...
    mapUrl: 'https://www.google.com/maps/dir/Senso-ji+Temple,+2+Chome-3-1+Asakusa,+Taito+City,+Tokyo+111-0032,+Japan/Henn+na+Hotel+Tokyo+Ginza,+2+Chome-2-1+Tsukiji,+Chuo+City,+Tokyo+104-0045,+Japan/',
    stops: [
      { zh: '淺草', ja: '浅草' },
      { zh: '東銀座', ja: '東銀座' },
      { zh: '築地', ja: '築地' },
  ...
  },
  {
    ...
    originalTitle: 'JMLA担当者と合流',
    description: {
      zh: '9:30 在飯店大廳與JMLA代表會合。',
      ja: '9:30 ホテルのロビーでJMLA担当者と合流します。',
    },
    isStarred: false,
    isPlaceholder: false,
    websiteUrl: '',
  ...
  },
  {
    ...
    description: {
      zh: '參觀東京大學醫學圖書館 (10:30-12:30)。它為醫學、生命科學研究和臨床需求提供了豐富的資源和空間。',
      ja: '東京大学医学図書館を見学します (10:30-12:30)。医学、生命科学の研究、臨床ニーズに応える豊富なリソースとスペースを提供しています。',
    },
    isStarred: true,
    isPlaceholder: false,
  ...
  },
  {
    ...
    description: {
      zh: '參觀健康與醫學博物館 (10:30-12:30)。位於東京都文京區，鄰近東京大學醫學院及其附屬醫院，是一座專注於醫學史、健康教育及現代醫學發展的專業博物館。與醫學圖書館位於同校區，步行即可抵達。',
      ja: '健康と医学の博物館を見学します (10:30-12:30)。東京都文京区に位置し、東京大学医学部とその附属病院に隣接しています。医学史、健康教育、現代医学の発展に焦点を当てた専門博物館です。医学図書館と同じキャンパス内にあり、徒歩でアクセス可能です。',
    },
    isStarred: false,
    isPlaceholder: false,
  ...
  },
  {
    ...
    day: { zh: '週三', ja: '水' },
    time: '下午',
    title: 'Capo PELLICANO本鄉店',
    originalTitle: 'Capo PELLICANO 本郷店',
    description: {
      zh: '於東京大學校園內的義大利餐廳享用午餐 (12:45-13:45)。',
      ja: '東京大学キャンパス内にあるイタリアンレストランで昼食 (12:45-13:45)。',
    },
    isStarred: false,
    isPlaceholder: false,
    websiteUrl: 'https://capo-pellicano.com/',
    notes: '',
  },
  {
    type: 'travel',
  ...
  },
  {
    ...
    description: {
      zh: '參觀東京大學總合圖書館 (14:00-16:00)。主要由本館和新建的地下書庫（Library Plaza）組成，擁有一個深達46米的自動化地下書庫，可容納約300萬冊圖書。',
      ja: '東京大学総合図書館を見学します (14:00-16:00)。主に本館と新設された地下書庫（ライブラリープラザ）から構成されており、深さ46メートルの自動化された地下書庫には約300万冊の図書を収容できます。',
    },
    isStarred: true,
    isPlaceholder: false,
  ...
  },
  {
    ...
    mapUrl: 'https://www.google.com/maps/dir/Jimbocho+Station,+Chiyoda+City,+Tokyo,+Japan/Henn+na+Hotel+Tokyo+Ginza,+2+Chome-2-1+Tsukiji,+Chuo+City,+Tokyo+104-0045,+Japan/',
    stops: [
        { zh: '神保町', ja: '神保町' },
        { zh: '大手町', ja: '大手町' },
        { zh: '日比谷', ja: '日比谷' },
  ...
  },
  {
    ...
    description: {
      zh: '參觀國際兒童文學館 (10:00-11:00)。其主體建築是1906年建立的帝國圖書館（現稱「磚瓦建築」），已被登記為東京都的歷史建築。',
      ja: '国際子ども図書館を見学します (10:00-11:00)。主体建築は1906年に設立された帝国図書館（現「レンガ棟」）であり、東京都の歴史的建造物として登録されています。',
    },
    isStarred: true,
    isPlaceholder: false,
  ...
  },
  {
    ...
    mapUrl: 'https://www.google.com/maps/dir/International+Library+of+Children\'s+Literature,+Uenokoen,+Taito+City,+Tokyo,+Japan/Shimbashi,+Minato+City,+Tokyo,+Japan/',
    stops: [
        { zh: '上野', ja: '上野' },
        { zh: '新橋', ja: '新橋' },
    ],
  ...
  },
  {
    ...
    time: '下午',
    title: '新橋地區午餐 (自由覓食)',
    originalTitle: '新橋で分散して昼食',
    description: {
      zh: '於新橋地區自由用餐。此區以眾多適合上班族的餐廳聞名。',
      ja: '新橋エリアで自由に昼食。このエリアはサラリーマン向けのレストランが多いことで知られています。',
    },
    isStarred: false,
    isPlaceholder: false,
    websiteUrl: 'https://www.google.com/maps/search/restaurants+in+shimbashi',
    notes: '',
  },
  {
    type: 'travel',
    ...
    mapUrl: 'https://www.google.com/maps/dir/Shimbashi+Station,+2+Chome+Shimbashi,+Minato+City,+Tokyo,+Japan/The+Jikei+University+School+of+Medicine,+Nishishinbashi,+Minato+City,+Tokyo,+Japan',
    stops: [
        { zh: '新橋', ja: '新橋' },
        { zh: '御成門', ja: '御成門' },
    ],
  ...
  },
  {
    ...
    day: { zh: '週四', ja: '木' },
    time: '下午',
    title: '東京慈惠會醫科大學 學術情報中心圖書館 & 史料室',
    originalTitle: '東京慈恵会医科大学 学術情報センター図書館 & 史料室',
    description: {
      zh: '參觀東京慈惠會醫科大學的附屬圖書館暨學術檔案中心 (14:00-15:30)。',
      ja: '東京慈恵会医科大学の附属図書館および学術アーカイブセンターを見学します (14:00-15:30)。',
    },
    isStarred: false,
    isPlaceholder: false,
  ...
  },
  {
    ...
    description: {
      zh: '拜會日本醫學圖書館協會 (JMLA) 總部 (16:00-17:00)。此為TMLA理監事限定行程，將與協會成員進行交流，並了解其運作模式與最新計畫。',
      ja: '日本医学図書館協会（JMLA）本部を表敬訪問します (16:00-17:00)。この訪問はTMLAの役員に限定されており、協会のメンバーと交流し、その運営モデルと最新のプロジェクトについて学びます。',
    },
    isStarred: false,
    isPlaceholder: false,
  ...
  },
  {
    ...
    time: '晚上',
    title: 'JMLA晚宴 (歡迎晚會)',
    originalTitle: 'JMLA懇親会 (歓迎夕食会)',
    description: {
      zh: '由JMLA主辦的歡迎晚宴 (18:00-20:00)，僅限理監事參加。',
      ja: 'JMLA主催の歓迎夕食会 (18:00-20:00)。理事・監事のみ参加。',
    },
    isStarred: false,
    isPlaceholder: false,
    websiteUrl: '',
  ...
  {
    type: 'travel',
    id: 'travel-21-to-hotel',
    duration: { zh: '約 30 分鐘', ja: '約 30 分' },
    method: 'subway',
    description: {
      zh: '步行或搭乘地鐵返回飯店。',
      ja: '徒歩または地下鉄でホテルに戻ります。',
    },
    mapUrl: 'https://www.google.com/maps/dir/Japan+Medical+Library+Association,+2-ch%C5%8Dme-2-15+Sotokanda,+Chiyoda+City,+Tokyo+101-0021,+Japan/Henn+na+Hotel+Tokyo+Ginza,+2+Chome-2-1+Tsukiji,+Chuo+City,+Tokyo+104-0045,+Japan/',
    notes: '',
  },
  {
    type: 'event',
  ...
  },
  {
    ...
    description: {
      zh: '參觀國立國會圖書館 (10:00-11:00)。NDL是日本唯一的國家圖書館。它成立於1948年，為國會議員、行政和司法機構，以及全體日本民眾和全球研究人員提供廣泛的館藏和資訊服務。',
      ja: '国立国会図書館を見学します (10:00-11:00)。NDLは日本唯一の国立図書館です。1948年に設立され、国会議員、行政・司法機関、そして日本の全国民および世界の研究者に幅広い蔵書と情報サービスを提供しています。',
    },
    isStarred: true,
    isPlaceholder: false,
  ...
  },
  {
    ...
    time: '下午',
    title: '早稻田地區午餐 (自由覓食)',
    originalTitle: '早稲田近辺で分散して昼食',
    description: {
      zh: '於早稻田大學附近自由用餐。此區有許多學生喜愛的平價美食。',
      ja: '早稲田大学周辺で自由に昼食。このエリアには学生に人気のリーズナブルなグルメがたくさんあります。',
    },
    isStarred: false,
    isPlaceholder: false,
    websiteUrl: 'https://www.google.com/maps/search/restaurants+in+waseda',
    notes: '',
  },
  {
    type: 'event',
    ...
    description: {
      zh: '參觀早稻田大學國際文學館 (14:00-15:00)。也被稱為「村上春樹圖書館」，是一個集學術圖書館、文學博物館和文化交流空間於一體的現代化設施。由建築師隈研吾設計。',
      ja: '早稲田大学国際文学館を見学します (14:00-15:00)。「村上春樹ライブラリー」としても知られ、学術図書館、文学博物館、文化交流スペースを一体化した近代的な施設です。建築家の隈研吾によって設計されました。',
    },
    isStarred: true,
    isPlaceholder: false,
  ...
  },
  {
    ...
    mapUrl: 'https://www.google.com/maps/dir/The+Waseda+International+House+of+Literature+(The+Haruki+Murakami+Library),+Nishiwaseda,+Shinjuku+City,+Tokyo,+Japan/Henn+na+Hotel+Tokyo+Ginza,+2+Chome-2-1+Tsukiji,+Chuo+City,+Tokyo+104-0045,+Japan/',
    stops: [
        { zh: '早稻田', ja: '早稲田' },
        { zh: '大手町', ja: '大手町' },
        { zh: '日比谷', ja: '日比谷' },
  ...
  },
  {
    ...
    method: 'subway',
    description: {
      zh: '從 Henn na Hotel 銀座前往慶應義塾大學醫學圖書館',
      ja: '変なホテル銀座から慶應義塾大学医学図書館へ',
    },
    mapUrl: 'https://www.google.com/maps/dir/Henn+na+Hotel+Tokyo+Ginza/Keio+University,+Kitasato+Memorial+Medical+Library,+35+Shinanomachi,+Shinjuku+City,+Tokyo,+Japan',
    stops: [
      { zh: '築地市場', ja: '築地市場' },
      { zh: '国立競技場', ja: '国立競技場' },
    ],
  ...
  },
  {
    ...
    time: '上午',
    title: '慶應義塾大學醫學圖書館',
    originalTitle: '慶應義塾大学北里記念医学図書館',
    description: {
      zh: '參觀慶應義塾大學信濃町校區的醫學圖書館，以其創始人之一北里柴三郎命名。館藏豐富的醫學文獻，支援大學的醫學教育與研究。',
      ja: '慶應義塾大学信濃町キャンパスにある医学図書館を見学します。創設者の一人である北里柴三郎にちなんで名付けられました。豊富な医学文献を所蔵し、大学の医学教育と研究を支援しています。',
    },
    isStarred: false,
    isPlaceholder: false,
    websiteUrl: 'https://www.med.keio.ac.jp/lib/',
    notes: '',
  },
  {
    type: 'travel',
    ...
    method: 'subway',
    description: {
      zh: '從慶應義塾大學（信濃町站）前往新宿地區',
      ja: '慶應義塾大学（信濃町駅）から新宿エリアへ',
    },
    mapUrl: 'https://www.google.com/maps/dir/Keio+University,+Kitasato+Memorial+Medical+Library,+35+Shinanomachi,+Shinjuku+City,+Tokyo,+Japan/Shinjuku+Station,+Shinjuku,Shinjuku+City,Tokyo,Japan/',
    stops: [
      { zh: '信濃町', ja: '信濃町' },
      { zh: '新宿', ja: '新宿' },
    ],
  ...
  },
  {
    ...
    time: '下午',
    title: '新宿地區免費導覽',
    originalTitle: '新宿エリア無料ツアー',
    description: {
      zh: '參加由東京都廳提供的免費導覽服務，探索新宿地區的魅力與景點。導覽時間約2.5小時 (13:00-15:30)。',
      ja: '東京都庁が提供する無料ガイドサービスに参加し、新宿エリアの魅力と名所を探索します。ツアー時間は約2.5時間です (13:00-15:30)。',
    },
    isStarred: false,
    isPlaceholder: false,
    websiteUrl: 'https://www.gotokyo.org/tc/guide-services/exploring-harajuku/index.html',
    notes: '此為東京都廳提供的免費導覽服務，需事先預約。\n12:45 前到達集合地點:東京旅遊資訊中心新宿高速巴士總站(Tokyo Tourist Information Center at Shinjuku Expwy. Bus Terminal 3F, 5-24-55 Sendagaya, Shibuya-ku, Tokyo Tel: 080-3219-4484 (on the day of tour)',
  },
  {
    type: 'travel',
    id: 'travel-106-to-109',
    duration: { zh: '約 10 分鐘', ja: '約 10 分' },
    method: 'walk',
    description: {
      zh: '從新宿導覽結束地點步行前往 Book and Bed Tokyo',
      ja: '新宿ツアー終了地点からBook and Bed Tokyoまで徒歩',
    },
    mapUrl: 'https://www.google.com/maps/dir/Shinjuku+Station,+Shinjuku,Shinjuku+City,Tokyo,Japan/BOOK+AND+BED+TOKYO+SHINJUKU,+Japan,+%E3%80%92160-0021+Tokyo,+Shinjuku+City,+Kabukicho,+1-ch%C5%8Dme%E2%88%9227%E2%88%925,KABUKI+BLDG,8F/',
    notes: '',
  },
  {
    type: 'event',
    ...
    day: { zh: '週六', ja: '土' },
    time: '下午',
    title: 'Book and Bed Tokyo 新宿店',
    originalTitle: 'Book and Bed Tokyo 新宿店',
    description: {
      zh: '參觀知名的「可以住的書店」，這是一個獨特的住宿概念，讓旅客能在書架環繞的環境中過夜。即使不住宿，也可作為特色咖啡廳參觀。',
      ja: '「泊まれる本屋」として知られるユニークな宿泊施設を見学します。宿泊しなくても、特色あるカフェとして利用できます。',
    },
    isStarred: false,
    isPlaceholder: false,
    websiteUrl: 'https://bookandbedtokyo.com/shinjuku/',
    notes: '參觀時間約為 16:00。',
  },
  {
    type: 'travel',
    id: 'travel-109-to-107',
    duration: { zh: '自由時間 / 步行', ja: '自由時間 / 徒歩' },
    method: 'walk',
    description: {
      zh: '從 Book and Bed 步行前往東京都廳，途中可自由活動或用餐',
      ja: 'Book and Bedから東京都庁まで徒歩。途中、自由行動や夕食も可能です',
    },
    mapUrl: 'https://www.google.com/maps/dir/BOOK+AND+BED+TOKYO+SHINJUKU,+Japan,+%E3%80%92160-0021+Tokyo,+Shinjuku+City,+Kabukicho,+1-ch%C5%8Dme%E2%88%9227%E2%88%925,KABUKI+BLDG,8F/Tokyo+Metropolitan+Government+Building,+Nishishinjuku,+Shinjuku+City,+Tokyo,+Japan/',
    notes: '晚餐可於新宿地區自行解決，有許多餐廳可供選擇。',
  },
  {
    type: 'event',
    id: 107,
    ...
    day: { zh: '週六', ja: '土' },
    time: '晚上',
    title: '東京都廳 TOKYO Night & Light 光雕秀',
    originalTitle: '東京都庁 TOKYO Night & Light プロジェクションマッピング',
    description: {
      zh: '欣賞在東京都廳第一本廳舍牆面上演的壯觀光雕投影秀，結合燈光、音樂與影像的藝術饗宴。',
      ja: '東京都庁第一本庁舎の壁面で繰り広げられる壮大なプロジェクションマッピングショーを鑑賞。光、音楽、映像が融合した芸術の饗宴です。',
    },
    isStarred: false,
    isPlaceholder: false,
    websiteUrl: 'https://tokyoprojectionmappingproject.jp/en/#timetable',
    notes: '17:30開始投影,哥吉拉19:00出現',
  },
  {
    type: 'event',
    id: 10,
