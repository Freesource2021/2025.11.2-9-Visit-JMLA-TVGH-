...
const initialItineraryData: ItineraryItem[] = [
  ...
  {
    type: 'travel',
    id: 'travel-106-to-107',
    duration: { zh: '自由時間 / 步行', ja: '自由時間 / 徒歩' },
    method: 'walk',
    description: {
      zh: '於新宿地區自由活動，晚餐後前往東京都廳欣賞光雕秀',
      ja: '新宿エリアで自由行動、夕食後、東京都庁へプロジェクションマッピングを鑑賞しに行きます',
    },
    mapUrl: 'https://www.google.com/maps/search/restaurants+in+shinjuku/@35.6909253,139.696425,16z/data=!3m1!4b1?entry=ttu',
